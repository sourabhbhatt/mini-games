  ...
  return (
    <>
      <div className="flex flex-col justify-start items-center">
        <h1 className="font-black px-4 uppercase text-center text-3xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-black to-white">
          Tic Tac Toe
        </h1>
        {gameMode === null && (
          <div className="flex flex-col h-full justify-center  items-center gap-4 p-4 mt-16">
            <Tooltip
              color="success"
              content="Play with friend in a online-room"
            >
              <Button
                color="success"
                variant="flat"
                className="text-lg font-extrabold tracking-widest p-8"
                size="lg"
                onPress={onOpen}
              >
                Online 1v1
            ...
            >
              <ModalContent>
                {(onClose) => (
                  <>
                    {onlineGameJoinOrCreate !== null && (
                      <ModalHeader className="flex flex-col gap-1">
                        {(onlineGameJoinOrCreate === true && "Join Room") ||
                          (onlineGameJoinOrCreate === false && "Create Room")}
                      </ModalHeader>
                    )}
                    <ModalBody>
                      <div className="flex flex-row w-full gap-2">
                        <Switch
                          isSelected={onlineGameJoinOrCreate}
                          color="danger"
                          onValueChange={setOnlineGameJoinOrCreate}
                        ></Switch>
            ...
            <Tooltip
              color="danger"
              placement="bottom"
              content="Play both players in a single screen"
            >
              <Button
                color="danger"
                variant="flat"
                className="font-bold tracking-widest p-6"
                size="lg"
